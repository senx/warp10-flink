...
public class WarpScriptRichFilterFunction<T> extends WarpScriptAbstractFunction implements RichFunction, FilterFunction<T> {

  public WarpScriptRichFilterFunction() throws WarpScriptException {
    super();
  }
  
  public WarpScriptRichFilterFunction(String code) throws WarpScriptException {
    super();
    setCode(code);
  }
