...
public class WarpScriptRichReduceFunction<T> extends WarpScriptAbstractFunction implements RichFunction, ReduceFunction<T>, ResultTypeQueryable<T> {

  private final boolean typeErasure;
  
  public WarpScriptRichReduceFunction() {
    super();
    typeErasure = false;
  }

  public WarpScriptRichReduceFunction(String code) throws WarpScriptException {
    super();
    setCode(code);
    typeErasure = true;
  }
  ...
  public T reduce(T value1, T value2) throws Exception {
    synchronized(this) {
      getStack().push(FlinkUtils.fromFlink(value1));
      getStack().push(FlinkUtils.fromFlink(value2));
