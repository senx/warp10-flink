...
public class WarpScriptRichWindowFunction<KEY, IN, OUT> extends WarpScriptAbstractFunction implements RichFunction, WindowFunction<IN, OUT, KEY, Window>, ResultTypeQueryable<OUT> {

  private final boolean typeErasure;
  
  public WarpScriptRichWindowFunction() {
    super();
    typeErasure = false;
  }

  public WarpScriptRichWindowFunction(String code) throws WarpScriptException {
    super();
    setCode(code);
    typeErasure = true;
  }
  ...
  @Override
  public void apply(KEY key, Window window, java.lang.Iterable<IN> input, org.apache.flink.util.Collector<OUT> out) throws Exception {
    synchronized(this) {
      getStack().push(FlinkUtils.fromFlink(key));
